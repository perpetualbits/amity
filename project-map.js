  ...
  nodes: [
    ...
    // ---- Flows -------------------------------------------------------------
    {
      ...
      parts: [
        ...
        { label: "Triage to typed entity", status: "seam", desc: "Task exists as a triage target and Event is planned, but TypedEntityRef is still a \"type:uuid\" string placeholder — the seams are drawn, the flow isn't built." },
      ],
